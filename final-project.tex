...
\hangindent=1cm
\hangafter=1
\noindent Butterworth, S. (1930). On the theory of filter amplifiers. \textit{Experimental Wireless and the Wireless Engineer}, \textit{7}, 536--541.

\vspace{6pt}

\hangindent=1cm
\hangafter=1
\noindent Lyons, R. G. (2011). \textit{Understanding digital signal processing} (3rd ed.). Prentice Hall.

\vspace{6pt}

\hangindent=1cm
\hangafter=1
\noindent Ogata, K. (2010). \textit{Modern control engineering} (5th ed.). Prentice Hall.

\vspace{6pt}

\hangindent=1cm
\hangafter=1
\noindent Oppenheim, A. V., Willsky, A. S., \& Nawab, S. H. (1997). \textit{Signals and systems} (2nd ed.). Prentice Hall.

\vspace{6pt}

\hangindent=1cm
\hangafter=1
\noindent Parks, T. W., \& Burrus, C. S. (1987). \textit{Digital filter design}. John Wiley \& Sons.

\vspace{6pt}

\hangindent=1cm
\hangafter=1
\noindent Proakis, J. G., \& Manolakis, D. G. (2007). \textit{Digital signal processing: Principles, algorithms, and applications} (4th ed.). Pearson Education.
