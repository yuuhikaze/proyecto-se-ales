% =========================================================================
% Pregunta 8: Diseño de filtro pasabajos análogo Butterworth
% Especificaciones: fp = 3 kHz, fs = 6 kHz, Rp = 1 dB, As = 16 dB
% =========================================================================

clear all; close all; clc;

%% Especificaciones del filtro
fp = 3000;                       % Frecuencia de paso: 3 kHz
fs = 6000;                       % Frecuencia de supresión: 6 kHz
Rp = 1;                          % Rizado en banda de paso: 1 dB
As = 16;                         % Atenuación en banda de supresión: 16 dB
...
semilogx([fp fp], [-80 5], 'g--', 'LineWidth', 1.5);
semilogx([fs fs], [-80 5], 'r--', 'LineWidth', 1.5);
semilogx([10 1e5], [-Rp -Rp], 'g:', 'LineWidth', 1);
semilogx([10 1e5], [-As -As], 'r:', 'LineWidth', 1);
grid on;
...
hold on;
semilogx([fp fp], [-200 10], 'g--', 'LineWidth', 1.5);
semilogx([fs fs], [-200 10], 'r--', 'LineWidth', 1.5);
grid on;
xlabel('Frecuencia (Hz)');
ylabel('Fase (grados)');
...
saveas(gcf, 'bode_butterworth_3kHz_6kHz.png');
...
saveas(gcf, 'polos_ceros_butterworth_3kHz_6kHz.png');
...
saveas(gcf, 'respuestas_tiempo_butterworth_3kHz_6kHz.png');
